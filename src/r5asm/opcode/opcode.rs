...
impl OpCode {
    ...
    pub (crate) fn from_str(s: &str) -> Option<Self> {
        match s.to_ascii_uppercase().as_str() {
            ...
            //K crypto extensions (supported subset)
            "PACK" => Some(Self::Pack),
            "PACKH" => Some(Self::Packh),
            "PACKW" => Some(Self::Packw),
            "XPERM4" => Some(Self::Xperm4),
            "XPERM8" => Some(Self::Xperm8),
            "BREV8" => Some(Self::Brev8),
            "ZIP" => Some(Self::Zip),
            "UNZIP" => Some(Self::Unzip),
            "AES64DS" => Some(Self::Aes64ds),
            "AES64DSM" => Some(Self::Aes64dsm),
            "AES64ES" => Some(Self::Aes64es),
            "AES64ESM" => Some(Self::Aes64esm),
            "AES64IM" => Some(Self::Aes64im),
            "AES64KS1I" => Some(Self::Aes64ks1i),
            "AES64KS2" => Some(Self::Aes64ks2),
            "SHA256SIG0" => Some(Self::Sha256sig0),
            "SHA256SIG1" => Some(Self::Sha256sig1),
            "SHA256SUM0" => Some(Self::Sha256sum0),
            "SHA256SUM1" => Some(Self::Sha256sum1),
            "SHA512SIG0" => Some(Self::Sha512sig0),
            "SHA512SIG1" => Some(Self::Sha512sig1),
            "SHA512SUM0" => Some(Self::Sha512sum0),
            "SHA512SUM1" => Some(Self::Sha512sum1),
            "SM3P0" => Some(Self::Sm3p0),
            "SM3P1" => Some(Self::Sm3p1),
            ...
            "CLZW" => Some(Self::Clzw),
            "CTZW" => Some(Self::Ctzw),
            "CPOPW" => Some(Self::Cpopw),
            "ROLW" => Some(Self::Rolw),
            "RORW" => Some(Self::Rorw),
            "RORIW" => Some(Self::Roriw),
            "MIN" => Some(Self::Min),
            "MINU" => Some(Self::Minu),
            "MAX" => Some(Self::Max),
            "MAXU" => Some(Self::Maxu),
