...
pub (crate) enum BasicInstructionExtensions {
    ...
    RvzbaInstructions,
    RvzbcInstructions,
    RvzicondInstructions,
    RvkCryptoInstructions,
...
impl BasicInstructionExtensions {
    pub (crate) fn from_str(s: &str) -> Option<Self> {
        match s.to_lowercase().as_str() {
            ...
            "rv_zbc_instructions" => Some(Self::RvzbcInstructions),
            "rv_zicond_instructions" => Some(Self::RvzicondInstructions),
            "rv_k_crypto_instructions" => Some(Self::RvkCryptoInstructions),
...
impl std::fmt::Debug for BasicInstructionExtensions {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            ...
            Self::RvzbcInstructions => "RVZbc",
            Self::RvzicondInstructions => "RVZicond",
            Self::RvkCryptoInstructions => "RVKCrypto",
